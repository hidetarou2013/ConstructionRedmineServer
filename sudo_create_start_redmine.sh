...
sudo docker pull hidetarou2013/svn-storage:latest 
...
#sudo docker build -t hidetarou2013/svn-storage github.com/hidetarou2013/svn-storage
...
# svn
sudo docker create --name svn-storage hidetarou2013/svn-storage
#sudo docker run --name myredmine1_svn -t -d -v /home/vagrant/web-contents/:/var/www/html/ -p 80:80 -p 443:443 hidetarou2013/centos6-apache:SVN_repo1
sudo docker run --volumes-from svn-storage --name myredmine1_svn -t -d -v /home/vagrant/web-contents/:/var/www/html/ -p 80:80 -p 443:443 hidetarou2013/centos6-apache:SVN_repo1
