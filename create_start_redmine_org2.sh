...
# docker stop myredmine1
# docker rm myredmine1
#docker run --name=myredmine1 -d -t -p 10080:80 --link myredmine1_mysql:mysql --link myredmine1_svn:svn --volumes-from myredmine1_redmine_storage hidetarou2013/redmine:v3.3.0_a
