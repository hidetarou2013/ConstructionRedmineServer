...
# run shell
# sh create_start_redmine3.sh myredmine3
...
echo "docker stop $1"
echo "docker rm $1"
echo "docker run --name=$1 -d -t -p 10080:80 --link $1_mysql:mysql --link $1_svn:svn --volumes-from $1_redmine_storage hidetarou2013/redmine:v3.3.0_a"
