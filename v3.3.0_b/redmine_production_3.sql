...
--
-- Host: localhost    Database: redmine_production
-- ------------------------------------------------------
...
CREATE TABLE `code_review_assignments` (
  ...
  `rev_to` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `code_review_project_settings` (
  ...
  `auto_assign` text COLLATE utf8_unicode_ci,
...
INSERT INTO `email_addresses` VALUES (1,1,'admin@example.net',1,1,'2016-09-08 09:21:50','2016-09-08 09:21:50');
...
--
-- Dumping data for table `theme_changer_user_settings`
--

LOCK TABLES `theme_changer_user_settings` WRITE;
/*!40000 ALTER TABLE `theme_changer_user_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `theme_changer_user_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tokens` VALUES (2,1,'session','cbc182b7c2f7c0100b32ef2915ee10d9e0f3c60e','2016-09-09 00:35:02','2016-09-09 00:35:28');
...
INSERT INTO `users` VALUES (1,'admin','daa0bbda3fe85b71098e6a5eedec08c39ed6e808','Redmine','Admin',1,1,'2016-09-09 00:34:38','',NULL,'2016-09-08 09:21:42','2016-09-09 00:35:02','User',NULL,'all','1ab0a2054ab1b02e43cb7d18a2765bff',0,'2016-09-09 00:35:02'),(2,'','','','Anonymous users',0,1,NULL,'',NULL,'2016-09-08 09:21:50','2016-09-08 09:21:50','GroupAnonymous',NULL,'',NULL,0,NULL),(3,'','','','Non member users',0,1,NULL,'',NULL,'2016-09-08 09:21:50','2016-09-08 09:21:50','GroupNonMember',NULL,'',NULL,0,NULL),(4,'','','','Anonymous',0,0,NULL,'',NULL,'2016-09-09 00:34:17','2016-09-09 00:34:17','AnonymousUser',NULL,'only_my_events',NULL,0,NULL);
...
--
-- Table structure for table `wiki_extensions_comments`
--

DROP TABLE IF EXISTS `wiki_extensions_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wiki_extensions_comments`
--

LOCK TABLES `wiki_extensions_comments` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_comments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_counts`
--

DROP TABLE IF EXISTS `wiki_extensions_counts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_counts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `wiki_extensions_counts`
--

LOCK TABLES `wiki_extensions_counts` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_counts` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_counts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_menus`
--

DROP TABLE IF EXISTS `wiki_extensions_menus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_menus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `wiki_extensions_menus`
--

LOCK TABLES `wiki_extensions_menus` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_menus` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_menus` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_settings`
--

DROP TABLE IF EXISTS `wiki_extensions_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `lock_version` int(11) DEFAULT NULL,
  `auto_preview_enabled` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wiki_extensions_settings`
--

LOCK TABLES `wiki_extensions_settings` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_tag_relations`
--

DROP TABLE IF EXISTS `wiki_extensions_tag_relations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_tag_relations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tag_id` int(11) DEFAULT NULL,
  `wiki_page_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_wiki_extensions_tag_relations_on_tag_id` (`tag_id`),
  KEY `index_wiki_extensions_tag_relations_on_wiki_page_id` (`wiki_page_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wiki_extensions_tag_relations`
--

LOCK TABLES `wiki_extensions_tag_relations` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_tag_relations` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_tag_relations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_tags`
--

DROP TABLE IF EXISTS `wiki_extensions_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `wiki_extensions_tags`
--

LOCK TABLES `wiki_extensions_tags` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_tags` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_extensions_votes`
--

DROP TABLE IF EXISTS `wiki_extensions_votes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wiki_extensions_votes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keystr` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `target_class_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `wiki_extensions_votes`
--

LOCK TABLES `wiki_extensions_votes` WRITE;
/*!40000 ALTER TABLE `wiki_extensions_votes` DISABLE KEYS */;
/*!40000 ALTER TABLE `wiki_extensions_votes` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-09  1:23:00
